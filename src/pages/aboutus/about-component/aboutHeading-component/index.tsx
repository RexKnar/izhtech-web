...
function AboutHeading() {
  return (
    <main className=" relative">
      ...
      <span className="hidden lg:block absolute xl:left-[38vw] top-[16vh] lg:left-[31vw] h-[365px] w-[368px] z-20 blueRound"></span>
      ...
      <section className=" flex justify-center  sm:pt-0  lg:px-6 xl:px-0">
        <div className="flex flex-col pt-24 container p-5 lg:p-0 ">
          <h1 className="text-3xl md:text-4xl font-bold pt-5 lg:pt-[7rem]  ">About Us</h1>
          <h3 className="pt-6 ">
      ...
      <section className=" ">
        <div className="grid lg:grid-cols-2 lg:gap-x-4 xl:gap-x-20 gap-">
          <div className="pb-5 lg:pb-0">
            <img src={videoImg} alt="" className="w-full h-auto lg:object-cover" />
          </div>

          <div className="grid md:grid-cols-2 xl:grid-cols-3 justify-center gap-20 content-center items-start p-5 lg:p-2 xl:p-0 ">
              ...
              <div className="grid justify-start xl:pt-16 pt-6">
                ...
                <Tooltip content="93%">
                  <button className="bg-transparent hover:!bg-transparent !border-none !px-0 ">
                    <div className="bg-gray-200 rounded-full h-2.5 dark:bg-gray-700 lg:w-[270px] xl:w-[290px] md:w-[50vw] w-[96vw]">
          ...
          <div className="grid  items-center justify-center content-center lg:gap-20 pb-0 p-5 lg:p-0">
            <div className="h-auto lg:p-3 xl:p-0 xl:w-[25vw] ">
