function Testimonials() {
  return (
    ...
    <>
      ...
      <section className="p-10 bg-black relative">

        <div className="bg-black flex flex-col lg:flex-row lg:space-x-4 text-white m-10 relative">
          <div className="lg:w-1/2 text-left mb-6">

            <h1 className="  pb-4 mb-3">TESTIMONIALS</h1>
          ...
          <div className="lg:w-1/2  text-left">
            <div className="mb-6">
              ...
              <span className="bg-gray-100 text-gray-600 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-gray-100 dark:text-gray-800">customer support</span>
