...
export function Brandingheader() {
    return (
        <>
            <section className="pr-32 pl-[45px] pb-10 pt-32">
                <div className="ml-4">
                    <h6 className="font-semibold text-sm ">Our Service</h6>
                    <h2 className="mt-2 font-bold text-5xl font-xs">Branding.</h2>
                </div>
            </section>
            <section className="pl-12 pr-32 ">
                <div className="flex gap-10">
                    <div className=" bottom-0 left-0">
                        <img className="relative object-cover h-96 max-w-xl ml-4" src={BranddetailImage} alt="" />
                        <div className="absolute rounded-md top-[273px] left-[156px] flex flex-col bg-white ">
