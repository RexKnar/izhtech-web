    ...
    return (
        <>
            <section className=" md:relative ">
                <div className="hidden sm:block md:absolute md:z-index md:-ml-[9px]  md:-mt-[12px] ">
                    <img src={ContentImage1} alt="" />
                </div>
                <div className="hidden sm:block md:absolute md:right-0 md:bottom-0 md:-mr-[19px];">
                    <img src={ContentImage2} alt="" className='h-[41rem]' />
                </div>
                <section>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-10 text-white md:py-24 bg-black md:pr-32 md:pl-[160px] p-9 py-12">
                        {
