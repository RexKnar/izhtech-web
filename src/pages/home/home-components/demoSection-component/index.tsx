  ...
  <main className='flex justify-center relative m-6'>
    ...
    <section className='container flex item-center justify-center  '>
        <div className='w-1/3 bg-transparent columns-3xl text-center p-4 '>
            <h1 className='font-bold text-4xl  text-center p-4'>We are <span className='text-transparent bg-gradient-to-r bg-clip-text from-indigo-500 via-purple-500 to-pink-500  text-cente text-4xl'>izh tech</span>,<br />Innovation ahead</h1>
<p>Helping SaaS teams to increase e-commerce conversions, 
reduce bounce rate, and <b>scale up fast</b>.</p>
